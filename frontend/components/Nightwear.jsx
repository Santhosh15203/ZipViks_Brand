...
export default function Nightwear({setItem}){
      ...
      useEffect(() => {
        ...
        fetch(
          `${import.meta.env.VITE_REACT_APP_PRODUCT_URL}/nightwear?page=${page}&limit=12`,{ signal }
        )
          .then((res) => res.json())
          .then((res) => {
            if (page === 1) {
              setProducts(res.nightwearproducts || []);
            } else {
              setProducts((prev) => [...prev, ...(res.nightwearproducts || [])]);
            }
                  ...
                  <div className=" mt-0 row">
                    {loading && page === 1 ? (
                      ...
                      <>
                        ...
                        <h5 className="text-center mt-3 fw-bold" style={{ fontFamily: "'Nunito Rounded', sans-serif"}}>Latest Night Wear Collections</h5>
