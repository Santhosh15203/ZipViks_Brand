                    ...
                    <div className=""> 
                      ...
                      <div className="text-start">
                       ...
                       <div className="d-flex mt-2 mb-2 justify-content-around ">
                        <div className="">
                          <input type="text"  className="form-control small-placeholder" placeholder="city*" name="city" value={city} required onChange={(e)=>{setCity(e.target.value)}}/>
                        </div>
                        <div className="w-50 ">
                          <select name="state" id="state" className="btn border w-75 small-select" value={state} required onChange={(e)=>{setState(e.target.value)}}>
                       ...
                       <div className="d-flex mt-2 mb-2 justify-content-around ">
                        <div className="">
                          <input type="text" maxLength={6} className="form-control small-placeholder" placeholder="postal / zipcode *" value={zipcode} name="zipcode" required onChange={(e)=>{setZipcode(e.target.value)}}/>
                        </div>
                        <div className="w-50">
                          <select name="country" id="country" className="btn border w-75 small-select" onChange={(e)=>{setCountry(e.target.value)}} value={country} required>
                      ...
                      <div className="d-flex mt-2 mb-2 justify-content-center">
                          <input type="checkbox" required checked={agree}  onChange={(e) => setAgree(e.target.checked)}/><span className="ms-2"> I agree all condition and terms.</span>
                      </div>
