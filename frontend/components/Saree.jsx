...
export default function Saree({setItem}){
      ...
      useEffect(() => {
        ...
        fetch(
          `${import.meta.env.VITE_REACT_APP_PRODUCT_URL}/saree?page=${page}&limit=12`,{ signal }
        )
          .then((res) => res.json())
          .then((res) => {
            if (page === 1) {
              setProducts(res.sareeproducts || []);
            } else {
              setProducts((prev) => [...prev, ...(res.sareeproducts || [])]);
            }
                  ...
                  <div className=" mt-0 row">
                    {loading && page === 1 ? (
                      ...
                      <>
                        ...
                        <h5 className="text-center mt-3 fw-bold" style={{ fontFamily: "'Nunito Rounded', sans-serif"}}>Latest Saree Collections</h5>
