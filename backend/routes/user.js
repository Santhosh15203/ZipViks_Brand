...
const { getMobileRegisterFormData } = require("../controllers/getMobileRegisterFormData")
...
router.get('/getMobileRegisterFormDataUser/:mobile',getMobileRegisterFormData)
